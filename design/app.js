...
const STYLES = [
  ...
  },
  {
    ...
    desc: '미술관 카탈로그 문법. 스위스 그리드 + Fig. 번호 + 도면·사진 병치.',
    cover: 'previews/cover_11_exhibition_proposal.html',
    meta: {
      '배경': '#F7F6F2',
      '텍스트': '#141310',
      '액센트': '#A8431E — Rust (폴리오·Fig. 번호)',
      '폰트': 'Space Grotesk · Noto Sans KR',
      '레이아웃': '스위스 컬럼 그리드 · 아카이브 라벨 · 도면+사진 병치',
      '용도': '전시 · 팝업 · 공간 제안'
    }
  },
  {
